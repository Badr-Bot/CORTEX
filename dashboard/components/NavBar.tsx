...
export default function NavBar() {
  ...
  return (
    <>
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-[#0a0a12]/95 backdrop-blur-md border-t border-indigo-500/15">
          ...
          {links.map((l) => {
            ...
            return (
              ...
              >
                ...
                {isActive && <span className="w-1 h-1 rounded-full bg-cyan-400 shadow-[0_0_6px_#22d3ee]" />}
              </Link>
            )
          })}
        </div>
